...
public final class Resources
{
	...
	*/
	...
	public static float read_base_scale_configuration()
	{
		...
		{
			final var scale =
				Integer.valueOf(Files.readString(Paths.get("base-scale.txt")));
	...
	{
		final var insets_frame =
			new JFrame("Insets frame", graphics_configuration)
			{
	...
	*/
	...
	protected static final Image pmChess_icon =
		load_image("icons/pmChess.png");
	
	protected static Image load_image(final String image_name)
	{
		final var image_url =
			Resources.class.getResource(image_name);
		if (image_url == null)
		{
		...
		final var image_unscaled =
			new ImageIcon(Toolkit.getDefaultToolkit().getImage(image_url));
		final var image_scaled =
			new ImageIcon(image_unscaled.getImage().getScaledInstance(
	...
	*/
	...
	protected static final Font font_regular =
		load_font("Open-Sans-Regular.ttf");
	protected static final Font font_italic =
		load_font("Open-Sans-Italic.ttf");
	protected static final Font font_bold =
		load_font("Open-Sans-Bold.ttf");
	protected static final Font font_bold_italic =
		load_font("Open-Sans-BoldItalic.ttf");
	
	protected static final Font font_chessclock =
		load_font("DSEG-7-Classic-BoldItalic.ttf");
	
	// Font including Unicode media control symbols according to ISO/IEC 18035:2003:
	protected static final Font font_media_control_symbols =
		load_font("Material-Symbols-Sharp.ttf", 1.6f);
	...
	*/
	...
	protected static final String text_encoding =
	...
	*/
	...
	private static final FigurePresentation[] figures =
		{
			  new FigurePresentation(Figure.pawn(true), "\u2659", "")
			, new FigurePresentation(Figure.rook(true), "\u2656", "R")
			, new FigurePresentation(Figure.knight(true), "\u2658", "N")
			, new FigurePresentation(Figure.bishop(true), "\u2657", "B")
			, new FigurePresentation(Figure.queen(true), "\u2655", "Q")
			, new FigurePresentation(Figure.king(true), "\u2654", "K")
			, new FigurePresentation(Figure.pawn(false), "\u265F", "")
			, new FigurePresentation(Figure.rook(false), "\u265C", "R")
			, new FigurePresentation(Figure.knight(false), "\u265E", "N")
			, new FigurePresentation(Figure.bishop(false), "\u265D", "B")
			, new FigurePresentation(Figure.queen(false), "\u265B", "Q")
			, new FigurePresentation(Figure.king(false), "\u265A", "K")
		};
	...
	protected static final class FigurePresentation
	{
		...
		protected static final Font font =
			load_font("Chess-Merida-Unicode.ttf", 1.2f);
